                    ...
                    <div className="modal-body">
                        <form className='modal-add-question'>
                            ...
                            <div className="mb-3">
                                ...
                                <textarea className="form-control" rows={3} id="textContent" name="textContent" onChange={(e) => setTextContent(e.target.value)} required />
                            ...
                            <div className="mb-3">
                                ...
                                <textarea className="form-control" rows={3} id="codeContent" name="codeContent" onChange={(e) => setCodeContent(e.target.value)} required />
                                <div className="invalid-feedback"> Please fill a code.</div>
                            </div>
                            <div className="mb-3">
                                <label htmlFor="tagName" className="form-label">Tag name</label>
                                <input type="text" className="form-control" id="tagName" name="tagName" onChange={(e) => setTagName(e.target.value)} required />
